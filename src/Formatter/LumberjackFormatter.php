<?php
/*
 * This file is a modified copy of Monolog\Formatter\LogstashFormatter
 */

namespace Bankiru\Yii\Logging\Logstash\Formatter;
 ...
 * @author Boris Gorbylev <gorbylev@banki.ru>
 */
class LumberjackFormatter extends NormalizerFormatter
{
    const V0 = 0;
    const V1 = 1;
